...
namespace Journey.Exception {
    ...
    public class ResourceErrorMessages {
        ...
        /// <summary>
        ///   Looks up a localized string similar to DATE_NOT_WITHIN_TRAVEL_PERIOD.
        /// </summary>
        public static string DATE_NOT_WHITIN_TRAVEL_PERIOD {
            get {
                return ResourceManager.GetString("DATE_NOT_WHITIN_TRAVEL_PERIOD", resourceCulture);
            }
        }
        ...
        /// <summary>
        ///   Looks up a localized string similar to The end date of trip must be equal or later the Start Date.
        /// </summary>
